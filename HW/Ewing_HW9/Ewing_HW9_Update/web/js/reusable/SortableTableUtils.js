...
SortableTableUtils.makeDecimal = function (num) {
    var tableData = document.createElement('td');
    ...
    if (!num) { // empty data
     ...
     var tmp = num + ""; // tmp will be num but converted to string.
        ...
        if (isNaN(tmp)) { // non numeric data
            ...
            num = num + "Must be numeric"; // preserve the original data when added this error msg.
        } else { // numeric data
            var convertedNum = parseFloat(tmp);

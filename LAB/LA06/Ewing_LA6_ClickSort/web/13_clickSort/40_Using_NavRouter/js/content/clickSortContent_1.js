    ...
    var content = `
        ...
        <p>
            ...
            <ul>
                ...
                <li>
                    js/reusable/MakeClickSort.js (creates the clickSort component - 
        ...
        <p>
            Check requirements of the ClickSort Homework -- you may not need to put two 
            ClickSort tables side by side. (Maybe I was just showing off :-)
        </p>
    `;
